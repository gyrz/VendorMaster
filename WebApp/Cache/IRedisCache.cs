...
namespace DataAccess.Cache
{
    public interface IRedisCache
    {
        ...
        Task<Result<T>> Remove<T>(string key, int id, Func<Task<Result<T>>> func);
        Task<Result<IEnumerable<T>>> GetListEverytime<T>(string key, Func<Task<Result<Dictionary<int,T>>>> func);
